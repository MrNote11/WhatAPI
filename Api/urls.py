...
urlpatterns = [
    ...
    path('87041883-4b66-46ed-9886-ad878e0bb080/', views.WhatsAppWebhookView.as_view(), name='twilio_webhook'),
    path('6c8c4825-dcba-4eec-be36-9bb19da00871/', views.FacebookWebhookView.as_view(), name='webhook')
]

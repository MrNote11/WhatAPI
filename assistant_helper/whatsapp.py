...
data = get_text_message_input(
    recipient=settings.WHATSAPP_RECIPIENT_NUMBER_ID, text="Hello, this is a test message."
)
...
async def send_message(data):
    ...
    async with aiohttp.ClientSession() as session:
        url = "https://graph.facebook.com" + f"/{settings.WHATSAPP_VERSION}/{settings.WHATSAPP_PHONE_NUMBER_ID}/messages"
        try:
